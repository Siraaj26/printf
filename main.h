...
unsigned int (*func)(va_list, buffer_t *, unsigned char, int, int,
unsigned char);
} converter_t;
...
/* prototype for main printf file */
int _printf(const char *format, ...);

/* Conversion Specifiers */
unsigned int convert_c(va_list args, buffer_t *output, unsigned char flags,
