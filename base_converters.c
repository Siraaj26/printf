...
/**
 * convert_sbase - Convert signed long to inputted base and stores
 * the result to buffer contained in a struct.
 * @output: A buffer_t struct containing a character array.
 * @num: A signed long to be converted.
 * @base: A pointer to string which contains the base to convert to.
